...
$upload_dir = '/dlna/'; // path from base_url to base of upload folder (with start and final /)
$current_path = '../dlna/'; // relative path from filemanager folder to upload folder (with final /)
