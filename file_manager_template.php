...
$settings = array(
    ...
    'file_icon' => '<img src="' . $this->static_url . '/img/files/%ext%.png" onerror="this.src=\'' . $this->static_url . '/img/files/unknown.png\'" />',
    'strings' => $this->strings,
    'loader' => '<img class="loader" src="' . $this->static_url . '/img/loader.gif" />'
);
?>
